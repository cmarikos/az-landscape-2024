CREATE OR REPLACE VIEW `prod-organize-arizon-4e1c0a83.viewers_dataset.ld23_pct_voters_2024` AS(
...
INNER JOIN `prod-organize-arizon-4e1c0a83.rich_christina_proj.catalist_pctnum_crosswalk_native` AS c
  ON b.uniqueprecinctcode = CAST(c.uniqueprecinctcode AS STRING)
